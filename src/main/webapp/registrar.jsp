        ...
        <div class="grid2">
            ...
            <section class="row2">
                ...
                <div id="sobrenomeSection">
                    <input type="text" name="sobrenome" id="sobrenome" class='campos' required>
                    <label for="sobrenome" class="input-label" id="inputSobreNome">Sobrenome *</label>
                </div>
                <div id="cpfSection">
                    <input type="text" name="cpf" id="cpf" class='campos' required maxlength='11'>
                    <label for="cpf" class="input-label" id="inputCpf">CPF *</label>
                </div>
                <div id="telefoneSection">
                    <input type="text" name="telefone" id="telefone" class='campos' required maxlength='11'>
                    <label for="telefone" class="input-label" id="inputTelefone">Telefone *</label>
                </div>

                <div id="datasNascSection">
                    <input type="date" name="datasNasc" id="datasNasc" class='campos' required>
                </div>
                ...
                <i class="fa-solid fa-arrow-right fa-3x" id="registrar" onclick="fazerRegistro()"></i>
            </section>
        </div>
    </div>
