...
<head>
    ...
    <link rel="stylesheet" href="styles/registrarFornecedor.css">
...
<body>
    ...
    <div class="informacoes-fundo">
        ...
        <div class="grid2">
            <section class="row">
                <span class="entre">Registrar</span>
                <span class="registrar"> <a href="login.jsp"> tem conta? clique aqui</a></span>
            </section>
            <section class="row2">
                <div id="nomeSection">
                    <input type="text" name="nome" id="nome" class='campos' required>
                    <label for="nome" class="input-label" id="inputNome">Nome*</label>
                </div>
                <div id="cnpjSection">
                    <input type="text" name="cnpj" id="cnpj" class='campos' required maxlength='11'>
                    <label for="cpf" class="input-label" id="inputCnpj">CNPJ*</label>
                </div>
                <div id="tipoEntregaSection">
                    <select name="tipoEntrega" id="tipoEntrega" class='campos'>
                        <option value="Entrega Fixa">Preço Fixo</option>
                        <option value="Entrega Por Km">Preço por km</option>
                    </select>
                    <label for="tipoEntrega" class="input-label" id="inputTipoEntrega">Tipo Entrega*</label>
                </div>

                <div id="precoEntregaSection">
                    <input type="number" name="precoEntrega" id="precoEntrega" class='campos' required>
                    <label for="precoEntrega" class="input-label" id="inputPrecoEntrega">Preço da entrega*</label>
                </div>

                <div id="emailSection">
                    <input type="text" name="email" id="email" class='campos' required>
                    <label for="email" class="input-label" id="inputEmail">Email*</label>
                </div>

                <div id="tipoSection">
                    <select name="tipo" id="tipo" class='campos'>
                        <option value="Restaurante">Restaurante</option>
                        <option value="Mercado">Mercado</option>
                        <option value="Bebidas">Bebidas</option>
                        <option value="Frutas">Frutas</option>
                    </select>
                    <label for="tipo" class="input-label" id="inputTipo">Tipo*</label>
                </div>

                <div id="senhaSection">
                    <input type="password" name="senha" id="senha" class='campos' required>
                    <label for="senha" class="input-label" id="inputSenha">Senha*</label>
                </div>

                <div id="senhaConfirmaSection">
                    <input type="password" name="senhaconfirma" id="senhaconfirma" class='campos' required>
                    <label for="senhaconfirma" class="input-label" id="inputSenhaConfirma">Confirmar Senha</label>
                </div>
                <i class="fa-solid fa-arrow-right fa-3x" id="registrar" onclick="fazerRegistroFornecedor()"></i>
            </section>
        </div>
    </div>
