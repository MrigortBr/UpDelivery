...
<%@page import="interfaces.IEnderecoServico"%>
<%@page import="servico.EnderecoServico"%>
...
<body>
	...
	<%	
		...
		ArrayList<Endereco> enderecos = endereco.listar(Integer.parseInt(token.pegarId(request)));
    ...
    <main class="fundoEndereco">
        <h1>Endereços</h1>
        
        <%for (Endereco end: enderecos){ %>
        <div class="cardEndereco" id="cardEndereco<%=end.getId()%>">
            <div class="headerEndereco" id="headerEnedereco<%=end.getId()%>">
                <img src="files/home.svg" alt="" class="icoHome">
                <input type="text" class="nomeEndereco" id="nomeEndereco<%=end.getId()%>" value="<%=end.getNome()%>" disabled>
            </div>
            <div class="informacoesEndereco" id="informacoesEndereco<%=end.getId()%>">
                <p class="ruaLabel" id="ruaLabel<%=end.getId()%>">Rua:
                    <input type="text" class="ruaInput" id="ruaInput<%=end.getId()%>" value="<%=end.getRua()%>" disabled>
                </p>
                <p class="bairroLabel" id="bairroLabel<%=end.getId()%>">Bairro:
                    <input type="text" class="bairroInput" id="bairroInput<%=end.getId()%>" value="<%=end.getBairro()%>" disabled>
                </p>
                <p class="cidadeLabel" id="cidadeLabel<%=end.getId()%>">Cidade:
                    <input type="text" class="cidadeInput" id="cidadeInput<%=end.getId()%>" value="<%=end.getCidade()%>" disabled>
                </p>
                <p class="numeroLabel" id="numeroLabel<%=end.getId()%>">Numero:
                    <input type="text" class="numeroInput" id="numeroInput<%=end.getId()%>" value="<%=end.getNumero()%>" disabled>
                </p>
                <p class="complementoLabel" id="complementoLabel<%=end.getId()%>">Complemento:<br>
                    <input type="text" class="complementoInput" id="complementoInput<%=end.getId()%>" value="<%=end.getComplemento()%>" disabled>
                </p>
                <p class="CEPLabel" id="CEPLabel<%=end.getId()%>">CEP:<br>
                    <input type="text" class="CEPInput" id="CEPInput<%=end.getId()%>" value="<%=end.getCep()%>" disabled>
                </p>
                
                <img src="files/delete.svg" alt="" class="deletarEndereco" id="deletarEndereco<%=end.getId()%>" onclick="deletar('<%=end.getId()%>')")>
                
            </div>
        </div>
        <%}; %>
        <h1>Adicionar Endereço</h1>
        <div class="cardEndereco" id="cardEndereco0">
            <div class="headerEndereco" id="headerEnedereco0">
                <img src="files/home.svg" alt="" class="icoHome">
                <input type="text" class="nomeEndereco" id="nomeEndereco0" placeholder="Adicionar novo Endereco">
            </div>
            <div class="informacoesEndereco" id="informacoesEndereco0">
                <p class="ruaLabel" id="ruaLabel0">Rua:
                    <input type="text" class="ruaInput" id="ruaInput0">
                </p>
                <p class="bairroLabel" id="bairroLabel0">Bairro:
                    <input type="text" class="bairroInput" id="bairroInput0">
                </p>
                <p class="cidadeLabel" id="cidadeLabel0">Cidade:
                    <input type="text" class="cidadeInput" id="cidadeInput0">
                </p>
                <p class="numeroLabel" id="numeroLabel0">Numero:
                    <input type="text" class="numeroInput" id="numeroInput0">
                </p>
                <p class="complementoLabel" id="complementoLabel0">Complemento:<br>
                    <input type="text" class="complementoInput" id="complementoInput0">
                </p>
                
                <p class="CEPLabel" id="CEPLabel0">CEP:<br>
                    <input type="text" class="CEPInput" id="CEPInput0">
                </p>

                <img src="files/send.svg" alt="" class="salvarEndereco" onclick="adicionar('0')">
